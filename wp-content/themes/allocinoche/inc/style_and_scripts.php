...
wp_register_script('bootstrap_script', JS_URL. '/assets/scripts/bootstrap.min.js', array('jquery'),'1.1', true);
// appel du script dans la page
wp_enqueue_script('bootstrap_script');

// enregistrement d'un nouveau script {Main.js}
wp_register_script('main_js', JS_URL.'/assets/scripts/main.js', array('jquery'),'1.1', true);
// appel du script dans la page
wp_enqueue_script('main_js');


// enregistrement d'un nouveau style {Bootstrap.css}
wp_register_style( 'bootstrap_style', CSS_URL. '/assets/styles/bootstrap.min.css' );
...
wp_register_style( 'main_style', CSS_URL. '/assets/styles/main.css' );
// appel du style dans la page
